...
class Docs extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
            ...
            'description' => esc_html__( 'List of your documentations.', 'docly' ),
            'customize_selective_refresh' => true,
        );
        parent::__construct( 'docly-docs', esc_html__( '(Docly) Docs List', 'docly' ), $widget_ops );
    ...
    public function widget( $args, $instance ) {
        ...
        $title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : esc_html__( 'Documentation List', 'docly' );
                ...
                <li>
                    <a href="<?php echo get_permalink($doc->ID); ?>">
                        ...
                        if ( $favicon_icon ) {
	                        ...
	                        echo get_the_post_thumbnail( $doc->ID );
                        }
