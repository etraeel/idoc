...
class Cheatsheet extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Cheat Sheet', 'docly-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'cheat_sheet_sec',
            [
                'label' => esc_html__( 'Cheat Sheet', 'docly-core' ),
            ]
        );
        ...
        $repeater->add_control(
            'cs_number', [
                'label' => __( 'Serial Number', 'docly-core' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Cheat Sheet List', 'docly-core' ),
        ...
        $this->add_control(
            'collapse_state', [
                'label' => esc_html__( 'Extended Collapse', 'docly-core' ),
                ...
                <div id="cheat-<?php echo esc_attr($id) ?>" class="card">
                    <div class="card-header" id="headingAtlas-<?php echo esc_attr($id) ?>">
                        <?php if ( $cheat_sheet_title ) : ?>
                            <h2 class="mb-0">
                                <button class="btn btn-link <?php echo esc_attr($is_collapsed_class) ?>" type="button" data-toggle="collapse" data-target="#collapseAtlas-<?php echo esc_attr($id) ?>" aria-expanded="<?php echo esc_attr($is_collapsed) ?>" aria-controls="collapseAtlas-<?php echo esc_attr($id) ?>">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="cheatsheet_item">
                                            ...
                                            if ( !empty( $item['cs_content'] ) ) {
                                                echo '<h4>'.wp_kses_post($item['cs_content']).'</h4>';
                                            }
                                            ?>
                                        </div>
                                    </div>
